...
var Rating_Rating = function Rating(_ref) {
  ...
  }, _toConsumableArray(Array(maxRate)).map(function (star, key) {
  ...
  })), react_default.a.createElement("div", null, rate, " of ", maxRate, " stars"));
};

/* harmony default export */ var components_Rating = (Rating_Rating);
// CONCATENATED MODULE: ./src/components/Time.js
...
/* harmony default export */ var components_Time = (Time_Time);
...
var Color_Color = function Color(_ref) {
  ...
  var deletion = function deletion(e, id) {
    e.preventDefault();
    onDelete(id);
  };
  ...
  return react_default.a.createElement("li", {
    ...
    onClick: function onClick(e) {
      return deletion(e, color.id);
    }
  }, "X"), react_default.a.createElement("h2", null, color.title), react_default.a.createElement(components_Time, {
  ...
  }), react_default.a.createElement(components_Rating, {
    rate: color.rating,
    onRate: function onRate(key) {
      return _onRate(color.id, key + 1);
    }
  }));
};
...
var List_ColorsList = function ColorsList(_ref) {
  ...
  }, !list.length ? react_default.a.createElement("h3", null, "No colors were loaded ...") : list.map(function (item, i) {
    return react_default.a.createElement(components_Color, {
      key: i,
      color: item,
...
/* harmony default export */ var List = (List_ColorsList);
// EXTERNAL MODULE: ./node_modules/uuid/index.js
var uuid = __webpack_require__(5);

// CONCATENATED MODULE: ./src/components/Add.js
...
/* harmony default export */ var lib_data = (data);
// CONCATENATED MODULE: ./src/helpers/index.js
function helpers_toConsumableArray(arr) { return helpers_arrayWithoutHoles(arr) || helpers_iterableToArray(arr) || helpers_nonIterableSpread(); }

function helpers_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance"); }

function helpers_iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === "[object Arguments]") return Array.from(iter); }

function helpers_arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }
...
var sortByDate = function sortByDate(items) {
  ...
  return helpers_toConsumableArray(items.sort(function (firstItem, secondItem) {
...
function (_Component) {
  ...
  function App(props) {
    ...
    _this.addColor = _this.addColor.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.deleteColor = _this.deleteColor.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.rateColor = _this.rateColor.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onSortColors = _this.onSortColors.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.state = {
      colors: sortByDate(lib_data),
      order: 'DESC'
    };
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function addColor(color) {
      var colors = sortByDate(App_toConsumableArray(this.state.colors).concat([color]));
      this.setState({
        colors: colors
      });
    }
    ...
    value: function rateColor(id, rating) {
      var colors = this.state.colors.map(function (color) {
        return color.id === id ? _objectSpread({}, color, {
          rating: rating
        }) : color;
      });
      this.setState({
    ...
    key: "onSortColors",
    value: function onSortColors(order) {
      var colors = sortByDate(this.state.colors, order);
      this.setState({
        colors: colors,
        order: order
      });
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        ...
        className: "header"
      }, react_default.a.createElement(Add, {
        onAddColor: this.addColor
      }), react_default.a.createElement(components_Sort, {
        onSort: this.onSortColors,
        order: this.state.order
      })), react_default.a.createElement(List, {
        list: colors,
        onDeleteColor: this.deleteColor,
        onRateColor: this.rateColor
      }));
    }
  }]);
...
Object(react_dom["render"])(react_default.a.createElement(App_App, null), document.getElementById('react-container'));

/***/ })
/******/ ]);
//# sourceMappingURL=bundle.804570611d12f6d05ed4.js.map